...
!function( $ ) {
		...
		_attachEvents: function(){
			...
			if (this.isInput) { // single input
				...
				if (this.componentReset) {
					this._events.push([
						this.componentReset,
						{/*click: $.proxy(this.reset, this)*/} // ASí no vacia el campo al hacer click
					]);
				}
			}
	...
	var dates = $.fn.datetimepicker.dates = {
		en: {
			...
			months: ["Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Sepitembre", "Octubre", "Noviembre", "Diciembre"],
