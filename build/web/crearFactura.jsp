...
<html lang="es">
    ...
    <title>Crear Factura - GestoSAT</title>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                            <%
                                ...
                                Cliente cli = gestoSAT.getCliente(Integer.parseInt(request.getParameter("id")));
                                // Datos del cliente
                                %>
                        ...
                        <div class="form-entradas">
                                ...
                                <div class='conf-attr'><span>Concepto:</span> <input type="text" id="conceptoFactura" class="input-cat-conf"/></div>
                                <div class='conf-attr'><span>Forma de pago:</span> <input type="text" id="formaPagoFactura" class="input-cat-conf"/></div>
                                <div class='conf-attr'><span>Observaciones:</span> <input type="text" id="observacionesFactura" class="input-cat-conf"/></div>
                        </div>
                        <div class="form-entradas">
                            <div>
                                <% Map albaranesCliente = cli.cargarAlbaranesPendientes(Integer.parseInt(request.getParameter("id")));
                                    if(albaranesCliente.isEmpty())
                                        response.sendRedirect("home.jsp?factura=true");
                                
                                    Iterator itAlbaranes = albaranesCliente.entrySet().iterator();
                                            ...
                                            <div class="col-md-12">
                                                <div class="my-panel my-panel-warning">
                                                    <div class="panel-heading">
                                                        <div class="flat-green"><input type="checkbox" checked value="<%out.println(auxAlbaran.getKey().toString().split(";")[0]);%>"/></div>
...
<!-- My Scripts -->
<script>
    idCliente = <%out.print(request.getParameter("id"));%>;
</script>
