                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                            <%
                                ...
                                Factura factura = gestoSAT.getFactura(Integer.parseInt(request.getParameter("id"))); 
                        ...
                        <div class="form-entradas">
                                <h4>Características de la factura</h4>
                                <div class='conf-attr'><span>Concepto:</span> <label class="my-label dynamic"><% out.print(factura.getConcepto()); %></label></div>
                                <div class='conf-attr'><span>Forma de pago:</span> <label class="my-label dynamic"><% out.print(factura.getFormaPago()); %></label></div>
                                <div class='conf-attr'><span>Observaciones:</span> <label class="my-label dynamic"><% out.print(factura.getObservaciones()); %></label></div>
                        </div>
                        <div class="form-entradas">
                                            ...
                                            <div class="col-md-12">
                                                <div class="my-panel my-panel-warning">
                                                    <div class="panel-heading">
                                                        <div class="flat-green"><input type="checkbox" <% out.print("disabled checked"); %> value="<%out.println(auxAlbaran.getKey().toString().split(";")[0]);%>"/></div>
                                                            ...
                                                            <table class="table table-bordered table-striped table-condensed cf">
                                                                <thead class="cf">
                                                                    <tr>
                                                                        <th>#</th>
                                                                        <th>Nombre</th>
                                                                        <th class="numeric">Precio<br/>unidad/hora</th>
                                                                        <th class="numeric">Uds/Horas</th>
                                                                        <th class="numeric">Total<br/>(IVA incl.)</th>
                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                        ...
                        <div class="form-entradas">
                            <div class="cat-conf">
                                ...
                                <p><span id="precioFactura"><% out.print(total); %></span><span>&euro;</span></p>
                            </div>
                        </div>
                            <% Map recibo =factura.cargarRecibo(Integer.parseInt(request.getParameter("id")));
                                if(recibo.isEmpty()){%>
                                <div>
                                    <button type='button' id='crearRecibo' class='btn btn-primary sep'>Crear Recibo</button>
                                ...
                                <%}else{
                                Iterator it = recibo.entrySet().iterator();
                                if(it.hasNext()){
                                    Map.Entry aux = (Map.Entry)it.next();
                                    out.print("<script type='text/javascript'>idRecibo="+aux.getKey().toString().split(";")[0]+";</script>");
                                }%>
                                <div>
                                    <button type='button' id='editarRecibo' class='btn btn-primary sep'>Ver Recibo</button>
                                    <button type='button' class='btn btn-primary sep' id="exportarPDF">Exportar PDF</button>
                                    <button type='button' class='btn btn-primary sep' id="exportarXLSX">Exportar XLSX</button>
                                </div>
                           <% } %>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>La factura debe contener al menos un albarán</p>
            </div>
...
<script>
    ...
    iva = parseFloat(<%out.print(gestoSAT.getIva()/(float)100);%>);
    
    $.each($("input[type=checkbox]"),function(){$(this).prop("disabled",true);$(this).prop("checked",true);});
    $(".icheckbox_flat-green").addClass("disabled");
</script>
<script src="js/editFactura.js"></script>
