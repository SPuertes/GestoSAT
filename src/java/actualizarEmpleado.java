...
public class actualizarEmpleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Gerente gerente = (Gerente)ses.getAttribute("usuario");
            ...
            if(gerente.modificarUsuario(sueldo, hora, ascenso, gestor.getEmpleado(Integer.parseInt(request.getParameter("id"))),Integer.parseInt(request.getParameter("id"))))
                out.print(true);
            else
                out.print(false);
