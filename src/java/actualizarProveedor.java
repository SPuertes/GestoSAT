...
public class actualizarProveedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        HttpSession ses = request.getSession();
            ...
            // Recuperar Proveedor posar nous datos
            // Manar a gestor per a guardar a la BD
            
            GestoSAT gestor = (GestoSAT)ses.getAttribute("gestor");
            Proveedor pro = gestor.getProveedor(id);
            
            if(pro.guardarCambios(id,request.getParameter("nombre"),request.getParameter("nif"),
                    ...
                    Integer.parseInt(request.getParameter("tlfFijo")),
                    Integer.parseInt(request.getParameter("tlfMovil")),
                    request.getParameter("email"),Integer.parseInt(request.getParameter("fax"))))
                out.print(true);
            else
                out.print(false);
