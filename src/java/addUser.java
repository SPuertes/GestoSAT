...
public class addUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(request.getParameter("gerente").equals("1")){
                
                if(gestor.crearGerente(new Gerente(request.getParameter("nombre"),
                ...
                Float.parseFloat(request.getParameter("hora")), request.getParameter("correo")),request.getParameter("pass")))
                    out.print(true);
                else
                    out.print(false);
            }else{
                if(gestor.crearEmpleado(new Empleado(request.getParameter("nombre"),
                request.getParameter("apellidos"), request.getParameter("dni"),
                request.getParameter("poblacion"), request.getParameter("provincia"),
                Integer.parseInt(request.getParameter("cp")), request.getParameter("calle"),
                request.getParameter("numero"),request.getParameter("escalera"),
