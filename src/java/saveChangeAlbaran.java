 ...
 * @author salvador
 */
public class saveChangeAlbaran extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            HttpSession ses = request.getSession();
                ...
                out.print(albaran.actualizar(idAlbaran,request.getParameter("8"),
                        request.getParameter("0"),request.getParameter("1"),
                        Integer.parseInt(request.getParameter("2")),request.getParameter("3"),
                        request.getParameter("4"),request.getParameter("5"),
                        Integer.parseInt(request.getParameter("6")),request.getParameter("7"),
                        empleados,material,request.getParameter("9")));
        }
    }
